...
const intro = [
    ...
    },
    {
        ...
        delay: "1200", 
        heading: "Marketing Mavericks", 
        price: "75,000", 
        detail_para: `It is a company's strategy for attracting potential customers and converting them into users of their goods or services. It includes their value propositions, critical brand messaging, information on the demographics of their target market, and other important aspects of the company's brand. A marketing plan, a document with all the information mentioned, contains the marketing strategy.This competition will have MCQs in the first round, followed by an abstract and then a ppt presentation in further rounds.` }, 
        { logo: Logo, 
        delay: "1500", 
        heading: "Strategy Sprint", 
        price: "75,000", 
        detail_para: `Students will get the opportunity to strengthen their skills in case analysis, network with consultants in a professional atmosphere, and engage in brainstorming the best ideas alongside some of the brightest minds from across the country. So, put on your consultant hats and get ready to address a critical consulting case problem your client is now dealing with.` }, 
        { logo: Logo, 
            delay: "1800", 
            heading: "Product Showdown", price: "75,000", detail_para: `"Good management is the art of making problems so interesting and their solutions so constructive that everyone wants to get to work and deal with them." - Paul Hawken. Product Showdown is a Business Event in Techkriti '23. It is an event where you can demonstrate and groom the managing skills that you acquire during the course of life. It would test participants on their ability to connect and apply their knowledge in general management, finance, marketing, operations, etc. and come up with the best possible solution for the problem statement.` }, { logo: Logo, delay: "2100", heading: "Trading", price: "50,000", detail_para: `Stock marketing describes the different exchanges where shares of various publicly traded and international corporations are bought and sold. It offers a virtual trading platform that is available from all around the world.TECHKRITI' 23 presents the finest platform to trade risk-free equities in the Virtual Stock Market.` }]
